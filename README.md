...
| Project | Description |
|---------|-------------|
| [c41.ch-be](https://github.com/adrirubim/c41.ch-be) | Modern, enterprise-grade blog CMS with Laravel 12, React 19 (Inertia.js), TypeScript and PostgreSQL. Professional UI/UX, security and performance. |
| [laser-packaging-laravel](https://github.com/adrirubim/laser-packaging-laravel) | Modern, enterprise-grade app for offers, articles, orders and production portal (web + API). Laravel 12, React 19 (Inertia.js), PostgreSQL. |
